...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-surface-elevated text-card-foreground flex flex-col gap-5 rounded-xl border border-gray-200 py-5 shadow-sm transition-shadow duration-200 hover:shadow-md",
        className
      )}
      {...props}
    />
